...
class NewsAppE2EUiIT extends AbstractTestcontainers {
    ...
    void createNews_viaApi_verifyRealTimeUpdate_inUi() {
        ...
        assertThat(page.locator(newsSelector + " .news-description").textContent()).isEqualTo("E2E real-time test");
...
@Test
    ...
    private void awaitReactionCount(NewsResponse createdNews, int expectedLikes, int expectedDislikes) {
        Awaitility.await()
                .atMost(10, TimeUnit.SECONDS)
                .until(() -> newsRepository.findById(createdNews.id())
