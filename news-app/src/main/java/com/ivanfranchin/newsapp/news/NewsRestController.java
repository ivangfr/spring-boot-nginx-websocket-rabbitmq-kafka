...
public class NewsRestController {
  ...
  public List<NewsResponse> getAllNews() {
    return newsService.getAllNews().stream().map(NewsResponse::from).toList();
  }
  ...
  @PostMapping
  public NewsResponse publishNews(
      @Valid @RequestBody(required = false) CreateNewsRequest createNewsRequest) {
    String description =
        createNewsRequest == null || createNewsRequest.description().isBlank()
  ...
  private static final List<String> SAMPLE_HEADLINES =
      List.of(
